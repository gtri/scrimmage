...
void PID::set_is_angle(const bool& is_angle) {
    is_angle_ = is_angle;
}

const double& PID::setpoint() {
    return setpoint_;
}
const double& PID::kp() {
    return kp_;
...
const double& PID::integral_band() {
    return integral_band_;
}
const double& PID::integral() {
    return integral_;
}
const double& PID::error() {
    return error_;
}
const double& PID::previous_error() {
    return prev_error_;
}
const double& PID::derivative() {
    return derivative_;
}
