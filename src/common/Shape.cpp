...
ShapePtr make_arc(const Eigen::Vector3d& center, const scrimmage::Quaternion& quat,
                  const double& radius, const double& angle, const Eigen::Vector3d& color,
...
ShapePtr make_arrow(const Eigen::Vector3d& pos, const scrimmage::Quaternion& quat,
                    const double& length, const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_circle(const Eigen::Vector3d& center, const scrimmage::Quaternion& quat,
                     const double& radius, const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_cone(const Eigen::Vector3d& direction, const Eigen::Vector3d& apex,
                   const double& height, const double& base_radius, const Eigen::Vector3d& color,
                   const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_cuboid(const Eigen::Vector3d& center, const scrimmage::Quaternion& quat,
...
ShapePtr make_ellipse(const Eigen::Vector3d& center, const scrimmage::Quaternion& quat,
                      const double& x_radius, const double& y_radius, const Eigen::Vector3d& color,
                      const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_line(const Eigen::Vector3d& start, const Eigen::Vector3d& stop,
                   const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_mesh(const std::string& name, const Eigen::Vector3d& center,
                   const scrimmage::Quaternion& quat, const double& scale,
                   const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_plane(const Eigen::Vector3d& center, const scrimmage::Quaternion& quat,
                    const double& x_length, const double& y_length, const std::string& texture,
                    const bool& diffuse_lighting, const Eigen::Vector3d& color,
                    const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_pointcloud(const std::list<Eigen::Vector3d>& points,
                         const std::list<Eigen::Vector3d>& point_colors, const double& size,
                         const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_polydata(const std::list<Eigen::Vector3d>& points, const Eigen::Vector3d& color,
                       const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_polygon(const std::list<Eigen::Vector3d>& points, const Eigen::Vector3d& color,
                      const double& opacity) {
    auto shape = make_shape(color, opacity);
    for (auto& point : points) {
...
ShapePtr make_polyline(const std::list<Eigen::Vector3d>& points, const Eigen::Vector3d& color,
                       const double& opacity) {
    auto shape = make_shape(color, opacity);
    for (auto& point : points) {
...
ShapePtr make_sphere(const Eigen::Vector3d& center, const double& radius,
                     const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_spline(const std::list<Eigen::Vector3d>& points, const Eigen::Vector3d& color,
                     const double& opacity) {
    auto shape = make_shape(color, opacity);
    for (auto point : points) {
...
ShapePtr make_text(const std::string& text, const Eigen::Vector3d& center,
                   const Eigen::Vector3d& color, const double& opacity) {
    auto shape = make_shape(color, opacity);
...
ShapePtr make_triangle(const Eigen::Vector3d& point0, const Eigen::Vector3d& point1,
                       const Eigen::Vector3d& point2, const Eigen::Vector3d& color,
                       const double& opacity) {
    auto shape = make_shape(color, opacity);
