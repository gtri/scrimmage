...
Autonomy::Autonomy()
    : state_(std::make_shared<State>()),
      desired_state_(std::make_shared<State>()),
      need_reset_(false),
...
RTreePtr& Autonomy::rtree() {
    return rtree_;
}

void Autonomy::set_rtree(RTreePtr& rtree) {
    rtree_ = rtree;
}

StatePtr& Autonomy::state() {
    return state_;
}

void Autonomy::set_state(StatePtr& state) {
    state_ = state;
}
...
std::string& Autonomy::logging_msg() {
    return logging_msg_;
}

bool Autonomy::get_is_controlling() {
...
std::string Autonomy::type() {
    return std::string("Autonomy");
}

bool Autonomy::step_autonomy(double /*t*/, double /*dt*/) {
    return true;
}
bool Autonomy::posthumous(double /*t*/) {
    return true;
}
void Autonomy::init() {
}
...
bool Autonomy::need_reset() {
    return need_reset_;
}

StatePtr& Autonomy::desired_state() {
...
ContactMapPtr& Autonomy::get_contacts() {
    return contacts_;
}

ContactMap& Autonomy::get_contacts_raw() {
    return *contacts_;
}
