...
bool create_metrics(const SimUtilsInfo &info,
  ...
  for (std::string metrics_name : info.mp->metrics()) {
    ...
    PluginStatus<Metrics> status = info.plugin_manager->make_plugin<Metrics>("scrimmage::Metrics",
                                                                             metrics_name,
                                                                             *info.file_search,
                                                                             config_parse,
                                                                             overrides,
...
bool create_networks(const SimUtilsInfo &info,
  ...
  for (std::string network_name : info.mp->network_names()) {
    ...
    PluginStatus<Network> status = info.plugin_manager->make_plugin<Network>("scrimmage::Network",
                                                                             network_name,
                                                                             *info.file_search,
                                                                             config_parse,
                                                                             overrides,
