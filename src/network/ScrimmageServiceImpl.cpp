...
grpc::Status scrimmage::ScrimmageServiceImpl::SendSimInfo(grpc::ServerContext* context,
...
grpc::Status scrimmage::ScrimmageServiceImpl::SendGUIMsg(grpc::ServerContext* context,
...
grpc::Status scrimmage::ScrimmageServiceImpl::SendContactVisual(
    grpc::ServerContext* context, const scrimmage_proto::ContactVisual* contact_visual,
    scrimmage_proto::BlankReply* reply) {
...
grpc::Status scrimmage::ScrimmageServiceImpl::SendShapes(grpc::ServerContext* context,
