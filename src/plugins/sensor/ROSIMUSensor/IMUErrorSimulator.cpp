...
void IMUErrorSimulator::CalculateParametersForFixedDeltaT(IMUErrorBudgetTemplate& errorBudget) {
    ...
    AccelVRWMSStdDev =
        sqrt(NominalDeltaT) * Eigen::Vector3d(errorBudget.XAccelVRWMPS2PerRtHzStdDev,
    ...
    GyroARWRadStdDev =
        sqrt(NominalDeltaT) * Eigen::Vector3d(errorBudget.XGyroARWRadPerSecPerRtHzStdDev,
...
NoisyIMUData IMUErrorSimulator::EachCycle(IMUErrorBudgetTemplate& errorBudget,
    ...
    OutputBodyFrameAccelErrors = errorBudget.SampleFrequency *
