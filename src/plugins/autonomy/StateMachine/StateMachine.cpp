...
#include <scrimmage/plugins/autonomy/StateMachine/StateMachine.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::StateMachine,
                StateMachine_plugin)

namespace scrimmage {
namespace autonomy {

void StateMachine::init(std::map<std::string, std::string> &params) {
...
bool StateMachine::step_autonomy(double t, double dt) {
