...
void AuctionAssign::init(std::map<std::string, std::string> &params) {
    ...
    // Setup Publishers
    start_auction_pub_ = advertise("SphereNetwork", "StartAuction", 10);
    bid_auction_pub_ = advertise("SphereNetwork", "BidAuction", 10);
    ...
    subscribe<auction::StartAuction>("SphereNetwork", "StartAuction", 10,
    ...
    subscribe<auction::BidAuction>("SphereNetwork", "BidAuction", 10,
