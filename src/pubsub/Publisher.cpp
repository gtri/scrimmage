...
Publisher::Publisher(const std::string& topic, const unsigned int& max_queue_size, const bool& enable_queue_size,
...
void Publisher::set_debug_info(MessageBasePtr msg, const std::string& type) {
    msg->debug_info = std::string("  publisher:  ") + "type (" + type + "), plugin (" + plugin_->name() + ")" +
