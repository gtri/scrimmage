...
bool MissionParse::parse_filecontents<LibXML2Parser>(LibXML2Parser& doc) {
    ...
    mission_file_content_.assign(
        mission_file_content_vec.cbegin(),
...
std::string MissionParse::kernel_dir() const {
    return kernel_dir_;
}
...
void MissionParse::set_lat_lon_alt_origin(
...
const std::list<std::string>& MissionParse::kernel_names() const {
