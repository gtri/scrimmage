...
if ("${AIRSIM_SOURCE_ROOT}" STREQUAL "AIRSIM_SOURCE_ROOT-NOTFOUND" OR
  ...
  set(AIRSIM_INCLUDE_DIRS ${AIRSIM_SOURCE_ROOT}/AirLib/include ${AIRSIM_SOURCE_ROOT}/external/rpclib/include)
  set(AIRSIM_LIBRARIES "${AIRSIM_SOURCE_ROOT}/cmake/output/lib/libAirLib.a"
    "${AIRSIM_SOURCE_ROOT}/cmake/output/lib/libAirSim-rpclib.a")
endif()
