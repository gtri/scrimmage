...
#ifndef INCLUDE_SCRIMMAGE_PLUGINS_AUTONOMY_GROUNDFOLLOWER_GROUNDFOLLOWER_H_
#define INCLUDE_SCRIMMAGE_PLUGINS_AUTONOMY_GROUNDFOLLOWER_GROUNDFOLLOWER_H_
...
namespace autonomy {
class GroundFollower : public scrimmage::Autonomy {
 public:
...
#endif  // INCLUDE_SCRIMMAGE_PLUGINS_AUTONOMY_GROUNDFOLLOWER_GROUNDFOLLOWER_H_
