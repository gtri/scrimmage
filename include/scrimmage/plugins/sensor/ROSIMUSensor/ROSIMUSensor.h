...
class ROSIMUSensor : public scrimmage::Sensor {
 ...
 protected:
  ...
  Eigen::Vector3d get_deltaV(Eigen::Vector3d pos, Eigen::Vector3d vel,
                             Eigen::Quaterniond bodyToEcef, double deltaT);
  ...
  Eigen::Quaterniond omega_to_q_dot(Eigen::Quaterniond qBToA,
