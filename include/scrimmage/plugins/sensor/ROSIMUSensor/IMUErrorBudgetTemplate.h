...
class IMUErrorBudgetTemplate {
 public:
    ...
    double XAccelVRWMPS2PerRtHzStdDev = 0.0;  // velocity random walk (VRW) 1-sigma in units of
                                              // meters per second (MPS) squared
    double YAccelVRWMPS2PerRtHzStdDev = 0.0;  // velocity random walk (VRW) 1-sigma in units of
                                              // meters per second (MPS) squared
    double ZAccelVRWMPS2PerRtHzStdDev = 0.0;  // velocity random walk (VRW) 1-sigma in units of
                                              // meters per second (MPS) squared
    // Quantization
