...
class IMUErrorBudgetTemplate {
 public:
    ...
    double XAccelAxisInRunBiasContinuousProcessNoiseVar = 0.0; // variance of continuous-time process noise driving in-run bias
    double YAccelAxisInRunBiasContinuousProcessNoiseVar = 0.0; // variance of continuous-time process noise driving in-run bias
    double ZAccelAxisInRunBiasContinuousProcessNoiseVar = 0.0; // variance of continuous-time process noise driving in-run bias
    // Velocity random walk
    double XAccelVRWMPS2PerRtHzStdDev = 0.0; // velocity random walk (VRW) 1-sigma in units of meters per second (MPS) squared
    double YAccelVRWMPS2PerRtHzStdDev = 0.0; // velocity random walk (VRW) 1-sigma in units of meters per second (MPS) squared
    double ZAccelVRWMPS2PerRtHzStdDev = 0.0; // velocity random walk (VRW) 1-sigma in units of meters per second (MPS) squared
    // Quantization
    ...
    double XGyroAxisInRunBiasContinuousProcessNoiseVar = 0.0; // variance of continuous-time process noise driving in-run bias
    double YGyroAxisInRunBiasContinuousProcessNoiseVar = 0.0; // variance of continuous-time process noise driving in-run bias
    double ZGyroAxisInRunBiasContinuousProcessNoiseVar = 0.0; // variance of continuous-time process noise driving in-run bias
    // Angle random walk
