...
class SimpleCollisionScore {
 public:
    ...
    void set_flight_time_start(double t) {
        flight_time_start_ = t;
    }
    void set_flight_time_end(double t) {
        flight_time_end_ = t;
    }
    void increment_non_team_collisions() {
        non_team_collisions_++;
    }
    void increment_team_collisions() {
        team_collisions_++;
    }
    void increment_ground_collisions() {
        ground_collisions_++;
    }

    void add_non_team_collisions(int c) {
        non_team_collisions_ += c;
    }
    void add_team_collisions(int c) {
        team_collisions_ += c;
    }
    void add_ground_collisions(int c) {
        ground_collisions_ += c;
    }
    void add_flight_time(double t) {
        flight_time_end_ += t;
    }

    int non_team_collisions() {
        return non_team_collisions_;
    }
    int team_collisions() {
        return team_collisions_;
    }
    int ground_collisions() {
        return ground_collisions_;
    }

    void set_max_flight_time(double t) {
        max_flight_time_ = t;
    }
    void increment_entity_count() {
        entity_count_++;
    }
    ...
    void set_team_collisions(int team_collisions) {
        team_collisions_ = team_collisions;
    }
    ...
    double flight_time() {
        return (flight_time_end_ - flight_time_start_);
    }
    double flight_time_end() {
        return flight_time_end_;
    }
    double flight_time_start() {
        return flight_time_start_;
    }
    double flight_time_norm() {
        return (flight_time() / max_flight_time_);
    }
