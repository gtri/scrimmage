...
#ifndef INCLUDE_SCRIMMAGE_PLUGINS_METRICS_TEAMCPA_TEAMCPA_H_
#define INCLUDE_SCRIMMAGE_PLUGINS_METRICS_TEAMCPA_TEAMCPA_H_
...
class TeamCPA : public scrimmage::Metrics {
 public:
    TeamCPA();
 ...
 protected:
    ...
    std::map<int, TeamCPAData> cpa_map_;
    CSV csv_;
    bool initialized_ = false;
    int team_id_;
    double after_time_s_;
 private:
};

} // namespace metrics
} // namespace scrimmage
#endif // INCLUDE_SCRIMMAGE_PLUGINS_METRICS_TEAMCPA_TEAMCPA_H_
