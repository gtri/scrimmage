...
class PluginManager {
 public:
    ...
    void print_plugins(const std::string& plugin_type, const std::string& title,
    ...
    template <class T>
    PluginStatus<T> make_plugin(std::string plugin_type, const std::string& plugin_name_xml,
