...
ShapePtr make_arc(const Eigen::Vector3d &center = Eigen::Vector3d(0, 0, 0),
                  const scrimmage::Quaternion &quat = scrimmage::Quaternion(0,
                                                                            0,
                                                                            0),
                  const double &radius = 1.0, const double &angle = M_PI / 2.0,
...
ShapePtr make_cone(const Eigen::Vector3d &direction = Eigen::Vector3d(0, 0, 1),
                   ...
                   const double &height = 1.0, const double &base_radius = 1.0,
                   const Eigen::Vector3d &color = Eigen::Vector3d(0, 0, 255),
                   const double &opacity = 1.0);

ShapePtr make_cuboid(
    const Eigen::Vector3d &center = Eigen::Vector3d(0, 0, 0),
    const scrimmage::Quaternion &quat = scrimmage::Quaternion(0, 0, 0),
    const double &x_length = 1.0, const double &y_length = 1.0,
    const double &z_length = 1.0,
    const Eigen::Vector3d &color = Eigen::Vector3d(0, 0, 255),
    const double &opacity = 1.0);

ShapePtr make_ellipse(
    const Eigen::Vector3d &center = Eigen::Vector3d(0, 0, 0),
    const scrimmage::Quaternion &quat = scrimmage::Quaternion(0, 0, 0),
    const double &x_radius = 2.0, const double &y_radius = 1.0,
    const Eigen::Vector3d &color = Eigen::Vector3d(0, 0, 255),
    const double &opacity = 1.0);
...
ShapePtr make_plane(
    const Eigen::Vector3d &center = Eigen::Vector3d(0, 0, 0),
    const scrimmage::Quaternion &quat = scrimmage::Quaternion(0, 0, 0),
    const double &x_length = 10.0, const double &y_length = 10.0,
    const std::string &texture = "", const bool &diffuse_lighting = false,
    const Eigen::Vector3d &color = Eigen::Vector3d(0, 0, 255),
    const double &opacity = 1.0);
...
ShapePtr make_pointcloud(const std::list<Eigen::Vector3d> &points,
                         ...
                         const Eigen::Vector3d &color = Eigen::Vector3d(0, 0,
                                                                        255),
                         const double &opacity = 1.0);
...
ShapePtr make_triangle(const Eigen::Vector3d &point0 = Eigen::Vector3d(1, 0, 0),
                       ...
                       const Eigen::Vector3d &point2 = Eigen::Vector3d(-1, 0,
                                                                       0),
                       const Eigen::Vector3d &color = Eigen::Vector3d(0, 0,
                                                                      255),
                       const double &opacity = 1.0);
