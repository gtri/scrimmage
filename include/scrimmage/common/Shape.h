...
ShapePtr make_cone(
    const Eigen::Vector3d& direction = Eigen::Vector3d(0, 0, 1),
...
ShapePtr make_line(
    const Eigen::Vector3d& start = Eigen::Vector3d(0, 0, 0),
    const Eigen::Vector3d& stop = Eigen::Vector3d(1, 0, 0),
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);

ShapePtr make_mesh(
    const std::string& name = "volkswagen",
    const Eigen::Vector3d& center = Eigen::Vector3d(0, 0, 0),
    const scrimmage::Quaternion& quat = scrimmage::Quaternion(0, 0, 0),
...
ShapePtr make_polydata(
    const std::list<Eigen::Vector3d>& points,
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);

ShapePtr make_polygon(
    const std::list<Eigen::Vector3d>& points,
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);

ShapePtr make_polyhedron(
    const std::list<Eigen::Vector3d>& points,
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);

ShapePtr make_polyline(
    const std::list<Eigen::Vector3d>& points,
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);

ShapePtr make_sphere(
    const Eigen::Vector3d& center = Eigen::Vector3d(0, 0, 0),
    const double& radius = 1.0,
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);

ShapePtr make_spline(
    const std::list<Eigen::Vector3d>& points,
    const Eigen::Vector3d& color = Eigen::Vector3d(0, 0, 255),
    const double& opacity = 1.0);
...
ShapePtr make_triangle(
    const Eigen::Vector3d& point0 = Eigen::Vector3d(1, 0, 0),
