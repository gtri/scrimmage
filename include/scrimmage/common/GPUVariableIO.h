...
#ifndef INCLUDE_SCRIMMAGE_COMMON_GPUVARIABLEIO_H_
#define INCLUDE_SCRIMMAGE_COMMON_GPUVARIABLEIO_H_
 ...
 *  Uses pure array's for underlying data store with work more efficently 
 *  with controllers and motion models implemented on a GPU.
 */
template <class Input, class Output>
class GPUVariableIO: public VariableIO {
 public:
    GPUVariableIO();
    ...
    const Output &output() { return output_; }
