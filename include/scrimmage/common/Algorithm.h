...
std::unordered_set<T> set_difference(const std::unordered_set<T> &container1, const std::unordered_set<T> &container2) {
...
template <class T = std::unordered_set<int>>
std::unordered_set<T> set_union(const std::unordered_set<T> &container1, const std::unordered_set<T> &container2) {
