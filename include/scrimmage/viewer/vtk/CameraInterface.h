...
#ifndef INCLUDE_SCRIMMAGE_VIEWER_VTK_CAMERAINTERFACE_H_
#define INCLUDE_SCRIMMAGE_VIEWER_VTK_CAMERAINTERFACE_H_
...
#endif  // INCLUDE_SCRIMMAGE_VIEWER_VTK_CAMERAINTERFACE_H_
