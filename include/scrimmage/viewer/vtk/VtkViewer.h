...
#ifndef INCLUDE_SCRIMMAGE_VIEWER_VTK_VTKVIEWER_H_
#define INCLUDE_SCRIMMAGE_VIEWER_VTK_VTKVIEWER_H_
...
class VtkViewer : public scrimmage::Viewer {
 public:
    VtkViewer();
...
#endif  // INCLUDE_SCRIMMAGE_VIEWER_VTK_VTKVIEWER_H_
